...
const Header = () => {
  ...
  const handleNavigation = (key) => {
    if (key === "about") navigate("/");
    else if (key === "birkman") navigate("/Services/Birkman");
    else if (key === "careerAdvising") navigate("/Services/CareerAdvising");
    else if (key === "interview") navigate("/Services/Interview");
    ...
    <header className="absolute w-full z-50 transition-all duration-300">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-7 flex items-center justify-between h-16 md:h-20 relative z-10">
        ...
        >
          ...
          <motion.button
            onClick={() => {
              handleNavigation("about"); // Navigate to root/about
            }}
        ...
        {/* Navigation Bar */}
        <nav className="md:flex hidden justify-between w-[550px] mx-auto">
          {["about", "birkman", "careerAdvising", "interview"].map(
            (item, index) => (
              <motion.button
                ...
                className="group relative text-gray-900 font-medium py-2 cursor-pointer hover:text-[#004f38] transition-colors duration-300"
                key={item}
              >
                {t(`header.${item}`)}
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-[#004f38] to-[#004f38] group-hover:w-full transition-all duration-300"></span>
              </motion.button>
            )
          )}
        </nav>
        ...
        <div className="md:flex hidden items-center space-x-8 rtl:space-x-reverse">
          ...
          <motion.button
            ...
            className="relative w-[8em] h-[3em] m-2 bg-gray-900 text-white font-bold text-[13px] rounded-[0.625em] border-none overflow-hidden z-0 group"
          >
        ...
        <div className="md:hidden flex items-center">
          <motion.button
            ...
            className={`relative p-2 transition-all duration-300 rounded-lg ${isOpen
              ...
              : "text-gray-900 hover:text-[#004f38] hover:bg-[#e6f2ef]"
              }`}
            onClick={toggleMenu}
          >
            <motion.div
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                <button onClick={closeContactForm}>
                  <FiX className="w-5 h-5 text-gray-500 hover:text-gray-700 font-extrabold" />
                </button>
              </div>
              {/* Contact Form Input */}
              <form className="space-y-4" onSubmit={handleSubmit}>
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#004f38] focus:border-[#004f38] bg-gray-100"
                    required
                  />
                </div>
